    ...
    Column(
        ...
        if (searchQuery.value.isEmpty() && hometown.isEmpty()) {
            ...
            LazyColumn(
                ...
                // Iterieren über die Vorhersageobjekte und Anzeige mit der WeatherCard-Komponente
                items(forecast) { forecastItem ->
                    WeatherCard(forecastItem = forecastItem) // Übergeben der Vorhersagedaten an die WeatherCard-Komponente
                }
            }
        }
    }
