...
class PopupService : Service() {
    ...
    override fun onCreate() {
        ...
        // Start des Services als Foreground Service mit einer dauerhaften Benachrichtigung
    ...
    private fun startForegroundServiceWithNotification() {
        // Erstellung und Start einer Benachrichtigung für den Foreground Service
        val notification = getNotification("Popup Service is running")
        startForeground(1, notification) // Notification ID 1 kennzeichnet die Benachrichtigung für diesen Service
    }
